...
def main():
    ...
    # model_path = r"F:\FAU\Thesis\HDMIBabelfishV2\experiments\scratch\YOLOv11_nano\yolo11n.pt"
    

    model = YOLO(model_path)
    

    project_dir = r"F:\FAU\Thesis\HDMIBabelfishV2\experiments\scratch\YOLOv11_nano"
